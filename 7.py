...
#     lambda x: two_pair(x),
#     lambda x: one_pair(x),
#     lambda x: True if len(set(x.replace("J",""))) == 5 else False
# ]
...
#     hand.group = best_group
#     if best_group not in groups:
#         groups[best_group] = [hand]
#     else:
#         groups[best_group].append(hand)
